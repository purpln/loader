...
public struct Device {
    ...
    init(pointer: OpaquePointer) throws {
        ...
        self.type = Class(rawValue: UInt32(descriptor.bDeviceClass))
...
extension Device: CustomStringConvertible {
    public var description: String {
        #"{"version": "\#(String(bcd, radix: 16, uppercase: false))", "vendor": "\#(String(vendor, radix: 16, uppercase: false))", "product": "\#(String(product, radix: 16, uppercase: false))", "type": "\#(type?.description ?? "nil")"}"#
    }
}
